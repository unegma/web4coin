...
type GLTFResult = GLTF & {
  ...
  materials: {
    ['m_fountain.003']: THREE.MeshStandardMaterial
  }
}
                ...
                <group name="Fountain_Mesh" position={[0, 0, -587.6]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
                  <group name="FountainBones" rotation={[0, 0, -Math.PI / 2]}>
                    <group name="Object_6">
                      ...
                      <skinnedMesh name="Object_24" geometry={nodes.Object_24.geometry} material={materials['m_fountain.003']} skeleton={nodes.Object_24.skeleton} />
                    </group>
                  </group>
                </group>
              </group>
