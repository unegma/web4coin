...
export default function RightSideDrawer(
  {infoOpen, toggleRightSideDrawer, setDrawerRightOpen, drawerRightOpen}:
    {infoOpen: any, toggleRightSideDrawer: any, setDrawerRightOpen: Function, drawerRightOpen: boolean}) {
